                ...
                <div class="card-body">
                    ...
                    <p class="float-right mb-2">
                        @if (Auth::guard('admin')->user()->can('product.create'))
                            <a class="btn btn-primary text-white" href="{{ route('admin.product.create') }}">Add New Product</a>
                        @endif
                    </p>
                        ...
                        <table id="dataTable" class="text-center">
                            ...
                            <tbody>
                               ...
                               <tr>
                                    ...
                                    <td>@if ($product->image != "")
                                        <img width="50" src="{{ asset('uploads/products_image/'.$product->image) }}" alt="">
                                    @endif
                                   </td>
                                    <td>{{ $product->name }}</td>
                                    ...
                                    <td>
                                            ...
                                            <a class="btn btn-success text-white" href="{{ route('admin.product.edit', $product->id) }}">Edit</a>
                                       
                                        
                                        
                                        <a class="btn btn-danger text-white" href="{{ route('admin.product.destroy', $product->id) }}"
